...
UI Thread (eframe::App)  <── crossbeam channel ──>  Scan Thread (jwalk)
       ...
       │   ├── sidebar.rs     : ボリューム容量バー、Top-N大きいアイテム、凡例
